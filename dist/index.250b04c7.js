...
let data;
fetch(`${_config.API_URL}${_config.API_KEY}`).then(response => response.json()).then(data => console.log(data)).catch(err => console.log('error'));

},{"core-js/stable":"1PFvP","regenerator-runtime/runtime":"62Qib","./config":"6pr2F"}],"1PFvP":[function(require,module,exports) {
...
_parcelHelpers.export(exports, "ITEM_PER_PAGE", function () {
  return ITEM_PER_PAGE;
});
const API_URL = 'https://api.rawg.io/api/platforms?key=';
const API_KEY = '1c37bd305da74ee99bbda4f42660bc71';
...
},{}]},["7BONy","3miIZ"], "3miIZ", "parcelRequire36d7")
