...
let url = `${_config.API_URL}${_config.API_KEY}&page_size=${_config.ITEM_PER_PAGE}`;
_helper.getFetch(url).then((data)=>{
    console.log(data);
    gameArray(data);
});
...
},{"./config":"beA2m","./helper":"aqMTk","core-js/stable":"eIyVg","regenerator-runtime/runtime":"cH8Iq"}],"beA2m":[function(require,module,exports) {
...
const API_KEY = '9d065327ffe04f4fa436837e6fa6f7c6';
...
},{"../internals/export":"2mZbc"}]},["drOo7","jKMjS"], "jKMjS", "parcelRequire3131")
